  ...
  function U(t, r, i = [], e = {}) {
    for (let o = 0; o < t.length; o++) {
      let s = t[o],
        a = i[i.length - 1] ?? null;
      if (s.kind === "context") {
        if (U(s.nodes, r, i, { ...e, ...s.context }) === 2) return 2;
        continue;
      }
      i.push(s);
      let f = !1,
    ...
    function m(k, x, y = {}, N = 0) {
      if (k.kind === "declaration") {
        ...
        if (i & 1) {
          ...
          let _ = l(V, R ?? "initial");
          (_.src = k.src), D ? c.push(_) : g.push(_);
        }
        o.add(k.params);
        let b = { ...k, nodes: [] };
        for (let V of k.nodes) m(V, b.nodes, y, N + 1);
      ...
      for (let [k, x] of a)
        for (let y of x) {
          ...
          let b = W(y.value),
            V = !1;
          if (
            (ee(b, (_, { replaceWith: L }) => {
              if (_.kind !== "function" || _.value !== "color-mix") return;
              let O = !1,
                H = !1;
              if (
                (ee(_.nodes, (I, { replaceWith: q }) => {
                  if (
                    I.kind == "word" &&
                    I.value.toLowerCase() === "currentcolor"
                  ) {
                    (H = !0), (V = !0);
                    return;
                  }
                  ...
                  do {
                    ...
                    oe.startsWith("var(") ? (X = W(oe)[0]) : (X = null);
                  } while (X);
                  q({ kind: "word", value: oe });
                }),
                O || H)
              ) {
                let I = _.nodes.findIndex(
                  (X) => X.kind === "separator" && X.value.trim().includes(",")
                );
                if (I === -1) return;
            ...
            continue;
          let R = { ...y, value: J(b) },
            D = G("@supports (color: color-mix(in lab, red, red))", [y]);
          (D.src = y.src), k.splice(N, 1, R, D);
        }
    if (i & 1) {
      let k = [];
      if (c.length > 0) {
...
`),
  ...
  var $o = new RegExp(`^${de.source} +${de.source} +${de.source}$`);
  function No(t) {
    return $o.test(t);
  }
  function E(t) {
  ...
  function Rr(t) {
      ...
      r.suggest(n, () => {
        ...
        for (let C of d()) {
          ...
          let P = [...(C.values ?? []), ...h(C.valueThemeKeys ?? [])],
            $ = [...(C.modifiers ?? []), ...h(C.modifierThemeKeys ?? [])];
    ...
    function o(n, d) {
      function h({ negative: A }) {
        return (w) => {
          ...
          if (C !== null) return d.handle(A ? `calc(${C} * -1)` : C, P);
        };
      }
      ...
      r.functional(n, (h) => {
        ...
        if (
          (h.value.kind === "arbitrary"
            ? ((A = h.value.value), (A = Z(A, h.modifier, t)))
    ...
    let m = () => j([S("--tw-pan-x"), S("--tw-pan-y"), S("--tw-pinch-zoom")]);
      ...
      ]);
    {
        ...
        r.functional(h, (w) => {
          ...
          if (w.value.kind === "arbitrary") {
            ...
            switch (
              ...
              default:
                return (
                  (C = Z(C, w.modifier, t)), C === null ? void 0 : A.color(C)
                );
            }
          }
          {
      ...
      var O = d;
      let n = () => j([S("--tw-border-style", "solid")]);
      d("border", {
        width: (h) => [
        ...
        if (h.value) {
          if (h.value.kind === "arbitrary") {
            ...
            switch (
              ...
              default:
                return (
                  (A = Z(A, h.modifier, t)), A === null ? void 0 : d.color(A)
                );
            }
          }
          {
        ...
        if (n.value) {
          if (n.value.kind === "arbitrary") {
            ...
            switch (
              ...
              default:
                return (
                  (d = Z(n.value.value, n.modifier, t)),
      ...
      });
    {
      ...
      r.functional("filter", (w) => {
        ...
        r.functional("drop-shadow", (w) => {
          ...
          {
            let P = t.get([`--drop-shadow-${w.value.value}`]),
    ...
    {
      let n = () => j([S("--tw-outline-style", "solid")]);
    ...
    e("text-shadow-initial", [L, ["--tw-text-shadow-color", "initial"]]),
      r.functional("text-shadow", (n) => {
        ...
        switch (n.value.value) {
          case "none":
            return n.modifier ? void 0 : [L(), l("text-shadow", "none")];
          case "inherit":
            return n.modifier
              ? void 0
              : [L(), l("--tw-text-shadow-color", "inherit")];
        }
        {
      ...
      ]);
    {
      ...
      e("shadow-initial", [h, ["--tw-shadow-color", "initial"]]),
        r.functional("shadow", ($) => {
          ...
          if ($.value.kind === "arbitrary") {
            let K = $.value.value;
            switch ($.value.dataType ?? Y(K, ["color"])) {
              case "color":
                return (
                  (K = Z(K, $.modifier, t)),
                  K === null
          ...
          {
            let K = te($, t, ["--box-shadow-color", "--color"]);
            if (K)
              return [
                h(),
                l("--tw-shadow-color", Q(K, "var(--tw-shadow-alpha)")),
      ...
      r.functional("ring", ($) => {
        ...
        if ($.value.kind === "arbitrary") {
          let T = $.value.value;
          switch ($.value.dataType ?? Y(T, ["color", "length"])) {
            case "length":
              return $.modifier
                ? void 0
      ...
      r.functional("ring-offset", ($) => {
        if ($.value) {
          ...
          {
            let T = te($, t, ["--ring-offset-color", "--color"]);
...
`);
  ...
  function Vr(t, r, i) {
    for (let e of r.nodes) {
      ...
      if (
        ...
        return { nodes: W(o), ratio: s === "ratio" };
      } else if (
        t.kind === "arbitrary" &&
        e.kind === "word" &&
        e.value[0] === "[" &&
  ...
  function jo(t, r) {
    if (t.kind === "arbitrary") {
      let a = t.value;
      return (
        t.modifier && (a = Z(a, t.modifier, r.theme)),
        ...
        U(p.nodes, (m, { replaceWith: v }) => {
            ...
            N % 2 === 0 && (x[b] = y), (y += b.length);
          {
            let N = Object.keys(x),
              ...
              V = m.src,
              R = b.astNodes.map((_) => {
                let L = b.nodeSorting.get(_)?.candidate,
                  O = L ? x[L] : void 0;
                if (((_ = structuredClone(_)), !V || !L || O === void 0))
                  return (
                    U([_], (I) => {
                      I.src = V;
                    }),
              ...
              D = [];
            for (let _ of R)
              if (_.kind === "rule") for (let L of _.nodes) D.push(L);
              else D.push(_);
            v(D);
          }
        });
          ...
          return (
            a.push(
              (async () => {
                ...
                let x = await i(g, r),
                  y = Se(x.content, { from: o ? x.path : void 0 });
...
`
  ...
  async function bi({
    ...
    let s = 0,
      a = [],
      f = [];
    U(i, (p, { parent: m, replaceWith: v, context: k }) => {
      if (p.kind === "at-rule") {
        if (p.name === "@plugin") {
...
`)) {
  ...
  async function bn(
    ...
    let a = null,
      ...
      x = [],
      y = null;
    U(t, (b, { parent: V, replaceWith: R, context: D }) => {
      if (b.kind === "at-rule") {
        if (
          b.name === "@tailwind" &&
          ...
          for (let L of _)
            if (L.startsWith("source(")) {
              ...
              y = { base: D.sourceBase ?? D.base, pattern: O.slice(1, -1) };
            }
          (p = b), (s |= 16);
        }
        if (b.name === "@utility") {
        ...
        if (b.name === "@source") {
          ...
          if (L) {
            let I = _ ? x : k,
              q = z(H, " ");
            for (let X of q) for (let oe of ht(X)) I.push(oe);
          } else v.push({ base: D.base, pattern: H, negated: _ });
          R([]);
          return;
        }
        if (
          ...
          if (b.nodes.length === 0) {
            ...
            if (O.length === 0 || O.some((q) => q.trim() === ""))
              throw new Error(
                `\`@custom-variant ${_} (${O.join(",")})\` selector is invalid.`
              );
            let H = [],
              I = [];
            for (let q of O)
            ...
            u.push((q) => {
              q.variants.static(
                ...
                (X) => {
                  ...
                  for (let n of H) oe.push(G(n, X.nodes));
                  X.nodes = oe;
                },
                { compounds: Ae([...I, ...H]) }
              );
            ...
            if (O.startsWith("source(")) {
              ...
              U(b.nodes, (I, { replaceWith: q }) => {
                if (
                  ...
                  return (
                    (I.params += ` source(${H})`),
                    q([ue({ sourceBase: D.base }, [I])]),
                    2
                  );
              });
            } else if (O.startsWith("theme(")) {
              let H = O.slice(6, -1),
                I = H.includes("reference");
              U(b.nodes, (q) => {
                if (q.kind !== "at-rule") {
                  if (I)
                    throw new Error(
...
${H}`);
    ...
    if (g) {
      let b = [];
      for (let [R, D] of N.theme.entries()) {
        if (D.options & 2) continue;
        let _ = l(me(R), D.value);
        (_.src = D.src), b.push(_);
      }
      let V = N.theme.getKeyframes();
      for (let R of V) t.push(ue({ theme: !0 }, [j([R])]));
  ...
  var Si = `@layer theme, base, components, utilities;
...
`;
  var Be = { index: Si, preflight: $i, theme: Ni, utilities: Vi };
  var kt = class {
    start(r) {
